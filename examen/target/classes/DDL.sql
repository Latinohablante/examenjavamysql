...
CREATE table region(
    ...
    idcountry INT,
    FOREIGN KEY (idcountry) REFERENCES country (id) ON DELETE SET NULL
);
...
CREATE table city(
    ...
    name VARCHAR(50) NOT NULL,
    idregion INT,
    FOREIGN KEY (idregion) REFERENCES region (id) ON DELETE SET NULL
);
...
CREATE table persons(
    ...
    idgender INT,
    FOREIGN KEY (idcity) REFERENCES city (id) ON DELETE SET NULL,
    FOREIGN KEY (idgender) REFERENCES gender (id) ON DELETE SET NULL
);
...
CREATE table persons_skill(
    ...
    FOREIGN KEY (idskill) REFERENCES skill (id) ON DELETE SET NULL
);
...
CREATE table stack_skill(
    ...
    idstack INT,
    idskill INT,
    FOREIGN KEY (idstack) REFERENCES stack (id) ON DELETE SET NULL,
    FOREIGN KEY (idskill) REFERENCES skill (id) ON DELETE SET NULL
);
